...
def attack(char_name: str, char_class: str) -> str:
    """Функция возвращает урон в зависимости от выбранного перса."""
    ...
    return print('Урон не нанесен!')


def defence(char_name: str, char_class: str) -> str:
    """Функция возвращает блокировку в зависимости от выбранного перса."""
    if char_class == 'warrior':
    ...
    return print('Вы не смогли блокировать удар!')


def special(char_name: str, char_class: str) -> str:
    """Функция возвращает урон  от СП в зависимости от выбранного перса."""
    if char_class == 'warrior':
    ...
    return print('Вас обманули!')


def start_training(char_name: str, char_class: str) -> str:
    """Начало игры - выбор персонажа."""
    if char_class == 'warrior':
